...
public class Main {
  public static void main(String[] args) {
    ...
    //Um programa que leia um valor inteiro N. Este valor sera a quantidade de valores inteiros X que serão lidos em seguida. Mostre quantos destes valores X estão dentro do intervalo [10, 20] e quantos estão fora do intervalo, mostrando essas informações;
